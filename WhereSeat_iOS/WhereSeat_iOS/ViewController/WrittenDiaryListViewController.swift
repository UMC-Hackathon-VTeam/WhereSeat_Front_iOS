...
final class WrittenDiaryListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "ellipsis")?.rotate(degrees: 90), menu: menu)
    ...
    private lazy var imgBtn: UIButton = {
        ...
        btn.setImage(UIImage(named: "Easteregg")?.resize(newWidth: view.safeAreaLayoutGuide.layoutFrame.width), for: .disabled)
